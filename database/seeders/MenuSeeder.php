...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        $menus = array(
            ...
            array('slug' => 'role-access-detail', 'menu_name' => 'Role Access Detail', 'parent_id' => '7'),
            array('slug' => 'documentation', 'menu_name' => 'Documentations', 'parent_id' => NULL),
            array('slug' => 'role-access-settings', 'menu_name' => 'Role Access Settings', 'parent_id' => '8'),
            array('slug' => 'role-access-permission', 'menu_name' => 'Role Access Permission', 'parent_id' => '10'),
