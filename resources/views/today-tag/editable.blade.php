                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="" name="order" required>
                                        ...
                                        @while ($i <= 20)
                                            ...
                                            @endforeach
                                            <option value="{{ $i }}"
                                                @if ($method === 'edit' and $today_tag->order_by_no === $i) selected @endif>{{ $i }}
                                            </option>
                                            @php $i++; @endphp
                                        @endwhile
                                    </select>
                                ...
                                <div class="form-group" id="form-group-tag">
                                    ...
                                    <select name="Tag[]" class="form-select" style='width: 100%;' multiple="multiple"
                                        ...
                                        @if ($method === 'edit' && isset($today_tag->tag))
                                            @php
                                                $array_response = json_encode($today_tag->tag, true);
                                            @endphp
                                            @foreach ($array_response as $value)
                                                <option value="{{ $value->id }}"
                                                    @if ($method === 'edit' and $value->id === $today_tag->tag) selected @endif> {{ $value->Tag }}
                                                </option>
                                            @endforeach
                                        @endif
                                    </select>
