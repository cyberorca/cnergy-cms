                                    ...
                                    <div class="card-body d-flex flex-column gap-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" class="my-editor form-control" id="content"
                                                      cols="30"
                                                      rows="10">
                                                @if ($method === 'edit') {{ $news->content }} @endif
                                            </textarea>
                                        </div>
                                    ...
                                    <div class="card-body d-flex flex-column gap-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="synopsis" class="form-control" id="synopsis"
                                                      cols="30"
                                                      rows="3" placeholder="Enter Synopsis"
                                            >@if($method === 'edit'){{$news->synopsis}} @endif</textarea>
                                                ...
                                                <select name="category" class="form-select" id="category">
                                                    @foreach($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                                @if ($method === 'edit' and $category->id === $news->category)
                                                                selected
                                                            @endif
                                            ...
                                            <fieldset class="form-group">
                                                <select name="type" class="form-select" id="type">
                                                    @foreach($types as $type)
                                                        <option value="{{ $type }}"
                                                                @if ($method === 'edit' and $type === $news->type)
                                                                selected
                                                            @endif
                                                        >{{ $type }}</option>
                                                    @endforeach
                                            ...
                                            <input name="isHeadline" class="form-check-input" type="checkbox"
                                                   id="isHeadline"
                                                   @if ($method === 'edit' and  $news->is_headline == '1')
                                                   checked
                                                @endif
                                            >
                                            ...
                                            <input name="isPublish" class="form-check-input" type="checkbox"
                                                   id="isPublish"
                                                   @if ($method === 'edit' and  $news->is_published == '1')
                                                   checked
                                                @endif
                                            >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="tags[]" class="choices form-select multiple-remove" multiple="multiple" id="tags">
                                                <optgroup label="Tags">
                                                    @foreach($tags as $id => $tag)
                                                        <option id="{{$id}}" value="{{$id}}"
                                                                @if ($method === 'edit' and  $tag->news()->find($news->id))
                                                                selected
                                                            @endif
                                                        >{{ $tag->tags}}</option>
                                                    @endforeach
