                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column gap-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="synopsis" placeholder="Enter Synopsis" class="form-control"
                                                      id="synopsis" cols="30" rows="3"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" class="my-editor form-control" id="content"
                                                      cols="30"
                                                      rows="10">@if ($method === 'edit'){{ $news->content }}@endif</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($method === 'edit')
                                                <input type="hidden" name="video_id"
                                                       value="{{ $news->news_videos[0]['id'] }}">
                                            @endif
                                            <textarea name="video" id="video" placeholder="Paste Embed Code Here"
                                                      class="form-control" cols="30" rows="3"
                                                      required>@if ($method === 'edit'){{ $news->news_videos[0]['video'] }}@endif</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
