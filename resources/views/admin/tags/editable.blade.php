                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tags" placeholder="Enter Tag Name" name="tag"
                            @if ($method==='edit' ) value="{{ $tag->tags }}" @endif>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="keywords" id="keywords" type="text" @if ($method==='create' )
                            placeholder="Enter Meta Keyword" @endif class="form-control" data-role="tagsinput" 
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-3">
                        ...
                        <button class="btn btn-primary" type="submit" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Create Tag Data">Save
                        </button>
