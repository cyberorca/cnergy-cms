            ...
            <table class="table" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href="{{ route('tag-management.edit', $t->id) }}" class="btn icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Tag Data">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#delete{{ $t->id }}" class="btn icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Tag Data">
                                <i class="bi bi-trash"></i>
                            </button>
                        </td>
                    </tr>
                    <div class="modal fade" id="delete{{ $t->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
