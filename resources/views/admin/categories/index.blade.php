...
@section('body')
    <x-page-heading title="Categories Settings" subtitle="Manage categories" />
    <section class="section">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between"><span class="h4">Categories</span>
