...
<section class="section">
    <div class="card col-md-7">
        ...
        <div class="card-header">
            <span class="h4 text-capitalize">{{ $method }} User</span>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="input-select" name="role">
                            ...
                            <option value="{{ $role->id }}" @if ($method==='edit' ) @if ($role->id ===
                                $post->roles->id)
                                selected @endif
                                @endif
                                >{{ $role->role }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-check-input" type="radio" name="is_active" @if ($post->is_active == 1) checked @endif value="1">
                            <label class="form-check-label">On</label>

                            <input class="form-check-input" type="radio" name="is_active" @if ($post->is_active == 0) checked @endif value="0">
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-3">
                        ...
                        <a href="{{ route('user-setting.index') }}" class="btn btn-light" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Back to Table User">Back
                        </a>

                        <button class="btn btn-primary" type="submit" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Create User Data">Save
                        </button>
