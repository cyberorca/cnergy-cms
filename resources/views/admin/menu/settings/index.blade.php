                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control @error('site_description') is-invalid @enderror"
                                id="basicInput" name="site_description" placeholder="Enter site description">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control @error('address') is-invalid @enderror"
                                id="basicInput" name="address" placeholder="Enter address">
                                @if ($menu_settings ?? null)
