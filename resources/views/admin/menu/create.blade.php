...
<section class="section">
    <div class="card col-md-7">
        ...
        <div class="card-header">
            <span class="h4">Create Menu</span>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    {{-- 
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput" name="url" placeholder="Menu URL" />
                        </div>

                        <div class="form-group">
                            <label for="basicInput" class="mb-2">Menu Icon</label>
                            <input type="text" class="form-control" id="basicInput" name="icon" placeholder="Menu Icon" />
                        </div> 
                    --}}
