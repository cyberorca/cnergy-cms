        ...
        <div class="px-3 ps-0 py-0 border-0" >
            <div class="d-flex align-items-center w-100 justify-content-between">
                ...
                <div class="d-flex gap-2">
                    <a class="btn btn-primary ms-3" href="{{ route('menu.create', $menu->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Add New Child Menu"><i class="bi bi-plus-circle-fill"></i></a>
