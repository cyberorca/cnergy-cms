    ...
    <div class="collapse show fade" id="photonews-${index}">
        <div class="card-body d-flex flex-column gap-2">
            <div class="row">
                ...
                <div class="col-md-7 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="keywords_photonews[]" id="image_keywords" type="text" required
            ...
            <div class="form-group">
                ...
                <textarea name="description_photonews[]" class="form-control" id="image_description" cols="30" rows="3" required
